...
async def verify_with_gemini(image_bytes: bytes) -> dict:
    ...
    payload = {"contents": [{"parts": [{"inline_data": {"mime_type": "image/jpeg", "data": image_b64}}, {"text": "Look at this image. Is there a YouTube Subscribed button visible? Answer only in JSON format: valid true or false with reason"}]}]}
